...
{
    public partial class Task7_PokazVacanc_seed2NewCateg : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    DateOfBegin = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    DateOfRespond = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ResumeId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responds_Resumes_ResumeId",
                        column: x => x.ResumeId,
                        principalTable: "Resumes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
